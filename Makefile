default:
	...
	g++ ddnsd-serial.cpp -I./ -o ddnsd-serial

install:
	@cp ./ddnsd /usr/bin/
	@cp ./ddnsd-serial /usr/bin/
	...
	@echo -e "ddnsd: \033[0;31mPlease edit /etc/ddns/ddnsd.conf and set serial using \"ddnsd-serial\".\033[0m"
